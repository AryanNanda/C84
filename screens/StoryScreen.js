...
this.setState({
  speakerColor : current_color === "gray"?"#fe5e00":"gray"
})
          ...
          <View style={styles.storyContainer}>
            <ScrollView style={styles.storyCard}>
              ...
              <View style={styles.dataContainer}>
                ...
                <TouchableOpacity 
                onPress = {()=>{
                  this.initiateTTS(this.props.route.params.story.title,this.props.route.params.story.author,this.props.route.params.story.story,this.props.route.params.story.moral)
                }}
                >
                  <Ionicons
